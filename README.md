...
- OpenAI Responses APIの `web_search` toolを使って、過去24時間を優先してニュースを調査します。
...
現在のプロンプトは、Appleだけを最優先にはしていません。AI・IT技術全体で重要度が高いニュースを優先します。

対象範囲は次です。

- AIモデル、生成AI、AIエージェント、AIアプリ
- OpenAI、Anthropic、Google、Microsoft、Meta、xAI、Perplexityなど
- Apple、Google、MicrosoftなどのOS・端末・プラットフォームへのAI統合
- NVIDIA、AMD、Intel、Qualcomm、ArmなどのAI半導体・AI実行基盤
- AI PC、オンデバイスAI、ローカルAI、エッジAI、AI搭載スマートフォン
- クラウドAI、API、開発基盤、AI検索、開発者ツール
